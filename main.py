...
urgent = ["SOS", "SAVE", "URGENT", "DANGER", "HELP", "STRANGER", "STALKING", "GUN", "KNIFE", "HOSPITAL", "ACCIDENT",
          "SUICIDE", "STALKED", "KILL", "BLOOD", "FUBAR"]
...
def welcome_spy():
    if spy.rating > 4.5:
        ...
        print "You are an outstanding addition to our spy community"

    elif 3.5 <= spy.rating <= 4.5:

        print "You are a good spy with room for improvement"
